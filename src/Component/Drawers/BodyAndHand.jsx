...
const Category = [
  { name: "See all Body & Hand", url: "see-all-body-hand" },
  { name: "Hand", url: "hand" },
  { name: "Body", url: "body" },
  { name: "Personal Care", url: "personal-care" },
  { name: "Body & Hand Care Bundles", url: "body-hand-care-bundles" },
  { name: "Body & Hand Care Gifts", url: "body-hand-care-gifts" },
];
const Range = [{ name: "Geranium Leaf", url: "gerenium-leaf" }];
const Daily_Essential = [
  {
    name: "Resurrection Rinse-Free Hand Mist",
    url: "resurrection-rinse-free-hand-mist",
  },
  {
    name: "Resurrection Aromatique Hand Balm",
    url: "resurrection-aromatique-hand-balm",
  },
  { name: "Déodorant Roll-On", url: "deodorant-roll-on" },
];
            ...
            >
              <Box>
                <img
                  ...
                  loading="eager"
                  src="https://www.aesop.com/u1nb1km7t5q7/11tFhBHEqkvZwHOiZMqGXo/0e2830ab4f36be98df48da3c57da1d5d/Aesop_Homepage_Navigation_Category_Body_Hand_Desktop_1700x2400px.jpg"
                />
              </Box>
            </VStack>
          </HStack>
