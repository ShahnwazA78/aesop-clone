...
const LinkText = (Type, List) => {
  return (
    <>
      <Heading fontSize={"x-medium"} color={"#333333"} paddingBottom={4}>
        {Type}
      </Heading>
      {List.map((ele) => (
        <Link to={ele.url}>
...
const Category = [
  { name: "See All Skin Care", url: "see-all-skin-care" },
  { name: "Cleanse", url: "cleanse" },
  { name: "Exfoliate", url: "exfoliate" },
  { name: "Treat & Masque", url: "treat-masque" },
  { name: "Tone", url: "tone" },
  { name: "Hydrate", url: "hydrate" },
  { name: "Eyes & Lips", url: "eyes-lips" },
  { name: "Shave", url: "shave" },
  { name: "Sun Care", url: "sun-care" },
  { name: "Kits", url: "kits" },
  { name: "Skin Care Bundle", url: "skin-care-bundle" },
  { name: "Skin Care Gifts", url: "skin-care-gifts" },
];
const SkinTypes = [
  { name: "Normal", url: "normal" },
  { name: "Dry", url: "dry" },
  { name: "Oily", url: "oily" },
  { name: "Combination", url: "combination" },
  { name: "Sensitive", url: "sensitive" },
  { name: "Mature", url: "mature" },
];
const Daily_Essential = [
  { name: "Parsley Seed Anti-Oxidant Intense Serum", url: "parsley-seed" },
  { name: "Exalted Eye Serum", url: "exalted-eye" },
  { name: "Lucent Facial Concentrate", url: "lucent-facial" },
];

const SkinCare = () => {
  return (
    <div className="component-wrapper skinCare">
      <Stack width={"100%"} height={"100%"}>
        <HStack height={"100%"}>
          <Box
            alignSelf={"flex-start"}
            margin={{ base: "1rem", md: "4rem 0 0 2rem" }}
          >
            <div className="logo">
              <h1 class="Logo_wrapper__hdqNp Logo_desktop__jWvZh Logo_active__Fhdj_">
                <a
                  class="Hyperlink_base__H3jim Hyperlink_left__UZaMy Hyperlink_dark__ROIlG Logo_base__azFYe Logo_light__KiBxr Logo_active__Fhdj_"
                ...
                >
                  ...
                  >
                    <title aria-label="Aesop logo" id="aesop-174">
                      Aesop
                    </title>
                    <g>
          ...
          >
            <VStack alignSelf={"flex-start"}>
              <Box padding={2} margin={{ base: ".8rem", md: "2rem 0 0 5rem" }}>
                {LinkText("Category", Category)}
              </Box>
            </VStack>
            <VStack alignSelf={"flex-start"}>
              <Box padding={2} margin={{ base: ".8rem", md: "2rem 0 0 5rem" }}>
                {LinkText("Skin Type", SkinTypes)}
              </Box>
            </VStack>
            <VStack alignSelf={"flex-start"}>
              <Box padding={2} margin={{ base: ".8rem", md: "2rem 0 0 5rem" }}>
                {LinkText("Daily Essential", Daily_Essential)}
              </Box>
            </VStack>
            <VStack
              alignSelf={"flex-start"}
            ...
            >
              <Box>
                <img
                  ...
                  loading="eager"
                  src="https://www.aesop.com/u1nb1km7t5q7/6Va39pw5RZBeMeQ9fdy2Zi/cdc6a081e7c8a3c361226cc5f86bb2cb/Aesop_Homepage_Navigation_Category_Skin_Desktop_1700x2400px.jpg"
                />
              </Box>
            </VStack>
          </HStack>
